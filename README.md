...
![Netflix Logo ](https://github.com/tanmaypatil19/netflix_sql_project/blob/main/netflix%20image.jpeg)
...
FROM netflix
WHERE type = 'TV Show'
  AND SPLIT_PART(duration, ' ', 1)::INT > 4;
```
...
### 13. Find How Many Movies Actor 'Salman Khan' Appeared in the Last 9 Years
...
**Objective:** Count the number of movies featuring 'Salman Khan' in the last 9 years.
